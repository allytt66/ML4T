...
class StrategyLearner(): 
    ...
    def get_price_state(self, sd, ed, symbol): 
        ...
        prices= prices.rename(columns={symbol: 'price'})
        ...
        #     sma_thres = [-np.inf, sma_stats['sma']['m'], sma_stats['sma']['75%'], np.inf]
        ...
        state_price= pd.concat([df_state, prices], axis=1).rename(columns={'sma': "state"})
